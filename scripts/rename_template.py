...
It renames all the occurrences of fetch_project (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the fetch_project folder
        os.rename(
            os.path.join(root_dir_path, "exts", "fetch_project", "fetch_project"),
            os.path.join(root_dir_path, "exts", "fetch_project", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "fetch_project"), os.path.join(root_dir_path, "exts", new_name))
